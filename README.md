...
- **Selbst gehostete Schriften** (siehe unten): "Baloo 2" (verspielte
  ...
  Symbols Outlined" (Icons, variable Schrift mit FILL-Achse für
  ausgefüllte/leere Sterne) – ursprünglich von Google Fonts, liegen aber als
  lokale Dateien im Projekt, siehe "Selbst gehostete Schriften" weiter unten.
